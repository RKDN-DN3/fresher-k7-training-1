...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20220710134740_Initial')
BEGIN
...
BEGIN
    CREATE TABLE [Todos] (
        ...
        CONSTRAINT [FK_Todos_AspNetUsers_UserId] FOREIGN KEY ([UserId]) REFERENCES [AspNetUsers] ([Id])
    );
END;
GO
...
BEGIN
    ...
    VALUES (N'20220710134740_Initial', N'6.0.6');
END;
GO
